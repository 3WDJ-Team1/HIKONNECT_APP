...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
   ...
   /* @Override
    protected void onNewIntent(Intent intent) {
        ...
        if (null != intent) {
            int defaultvalue = 0;
            int uke = intent.getIntExtra("user_number",0);
            Toast.makeText(MapsActivity.this,uke,Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_info_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("SSIBAL", String.valueOf(all_distance)+My_member_num);
                intent.putExtra("all_distance",all_distance);
                intent.putExtra("my_num", My_member_num);
                intent.putExtra("my_distance", hiking_distance);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST: {
                int result = data.getIntExtra("user_number",0);
                for (int a = 0; a < markers.size(); a++) {
                    if (markers.get(a).getSnippet().toString().equals("people")) {
                        if (markers.get(a).getTag().toString().equals(String.valueOf(result))) {
                            mMap.moveCamera(CameraUpdateFactory.newLatLng(markers.get(a).getPosition()));
                            Intent intent = new Intent(MapsActivity.this, HikingRecord.class);
                            intent.putExtra("member_no", result);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                ...
                for (int a = my_current_id - 1; a <= my_current_id + 1; a++) {
                    ...
                    if (a < polylinegroup.size()) {
                        for (int b = 0; b < polylinegroup.get(a).size(); b++) {
                            ...
                            start++;
                            Log.d("!@##$", String.valueOf(kedistance)+"/" +String.valueOf(minimum)+"/" + minimum_group_poly +"/"+ String.valueOf(minimum_poly));
                        }
                    }
                }
                ...
                Log.d("distance_now",String.valueOf(distance));
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if (positionuser == My_member_num) {
                                    ...
                                    markers.add(marker);
                                    absolutevalue++;
                                    Log.d("markers",String.valueOf(markers));
                                ...
                                mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                                    ...
                                    public boolean onMarkerClick(Marker marker) {
                                        if (marker.getSnippet().equals("people")) {
                                            ...
                                            intent1.putExtra("all_distance",all_distance);
