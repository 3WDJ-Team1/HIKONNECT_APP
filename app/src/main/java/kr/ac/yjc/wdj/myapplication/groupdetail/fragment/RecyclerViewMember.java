...
public class RecyclerViewMember extends Fragment {
    ...
    public static RecyclerViewMember newInstance() {
        return new RecyclerViewMember();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(GroupDetailMainActivity.adapterMember);
    }
}
